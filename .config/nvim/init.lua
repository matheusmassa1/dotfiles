...
require('lazy').setup({
  ...
  'tpope/vim-sleuth',
  -- Install commonlisp, clj support with conjure
  {
    'Olical/conjure',
    ft = { 'clojure', 'lisp' },
...
require('which-key').register({
  ["<leader>nt"] = { ":NvimTreeToggle<CR>", "Toggle NvimTree" },
...
vim.defer_fn(function()
  require('nvim-treesitter.configs').setup {
    ...
    ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'javascript', 'typescript', 'vimdoc', 'vim', 'bash', 'clojure' },
